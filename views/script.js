...
function graph() 
{
	...
	var chosen2 = document.getElementById("effect");

	var chosen3 = document.getElementById("xaxis");
...
document.getElementById("sol").innerHTML = "<p style = "+"text-align:justify" +"><font size=5 > A solution can be achieved by investing in technology, thus helping increase food production without compromising quality.  In today’s world, there are a lot of sensor based technologies capable of identifying imperfections and can improve the quality of the yield, therefore reducing waste.  </font>";
}
...
document.getElementById("sol").innerHTML = "<p style = "+"text-align:justify" +"><font size=5 text-align:justify text-justify: inter-word> A solution can be achieved by investing in technology, thus helping increase food production without compromising quality.  In today’s world, there are a lot of sensor based technologies capable of identifying imperfections and can improve the quality of the yield, therefore reducing waste.  </font>";
}
function graph3()
{
